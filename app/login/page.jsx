  ...
  return (
    <div className='flex justify-center items-center h-screen '>
      <div className="flex flex-col justify-center gap-5 items-center border-2 border-rose-quartz-2 pb-10 px-10 rounded-xl bg-[#F7F7F7] z-10">
        ...
        <button type="button" className="min-w-full border-2 border-light-cyan rounded-lg h-12 bg-columbia-blue text-neutral-100 text-lg hover:bg-light-cyan hover:border-columbia-blue" onClick={ () => alert( "hello" ) }>Login</button>
        ...
        <p>Don&#39;t have an account? <span className="text-cyan-600 cursor-pointer" onClick={ () => push( "/register" ) }>Register</span></p>
      </div>
    </div>
  );
};
